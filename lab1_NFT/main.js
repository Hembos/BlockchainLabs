...
const contract_addr = "0x90Ad3CeB650B97E888202725E6866BC7005F9e33";
...
function fetchNFTMetada(NFTs) {
    ...
    for (let i = 0; i < NFTs.length; i++) {
        ...
        promises.push(fetch("https://glko4xadf7mq.usemoralis.com:2053/server/functions/getNFT?_ApplicationId=Yh8rluxMC8wp6zXCQhJ3g2RXF4aNGHVuKrqJcMXZ&nftId=" + id)
        .then(res => res.json())
